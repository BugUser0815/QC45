...
struct GridStatus: Codable { let online: Bool; let l1: Double; let l2: Double; let l3: Double; let max: Double }
struct ConnectorStatus: Codable, Identifiable { let id: Int; let name: String; let powerKw: Int; let limitKw: Int; let energyRaw: Int64; let active: Bool; let idTag: String }

@MainActor
final class AppSettings: ObservableObject {
    @Published var baseURL: String { didSet { UserDefaults.standard.set(baseURL, forKey: "baseURL") } }
    @Published var token: String { didSet { Keychain.save(token, key: "remoteApiToken") } }
...
enum Keychain {
    static func save(_ value: String, key: String) {
        ...
        var add = query; add[kSecValueData as String] = data; SecItemAdd(add as CFDictionary, nil)
    }
